            ...
            <div className="w-full h-screen flex flex-col justify-start">
                ...
                <div className="">
                    <menu className="grid xl:grid-cols-3  xl:w-full xl:gap-x-[0.4rem] place- px-4 xl:px-16 gap-y-2 text-white">
                        ...
                        <Link to="/Bershkacopy/AppWomen" target="_self" className="h-full flex flex-col justify-end bg-womenm bg-cover bg-top-4 bg-no-repeat left-0 right-0">
                            <h2 className="text-[.75rem] text-center">GO TO FASHION</h2>
                            <p className="text-[2rem] text-center">WOMEN</p>
                        </Link>
                        </div>
                        <div className="relative h-[25vh] xl:h-[65vh]">
                        <Link to="/Bershkacopy/AppMen" className="h-full flex flex-col justify-end bg-men  bg-cover bg-top-4 bg-no-repeat left-0 right-0">
                            <h2 className="text-[.75rem] text-center">GO TO FASHION</h2>
                            <p className="text-[2rem] text-center">MEN</p>
                        </Link>
                        </div>
                        <div className="relative  h-[25vh] xl:h-[65vh] ">
                        <Link to="/Bershkacopy/AppTeen" className="h-full flex flex-col justify-end bg-teen  bg-cover bg-top-4 bg-no-repeat left-0 right-0">
                            <h2 className="text-[.75rem] text-center">GO TO FASHION</h2>
